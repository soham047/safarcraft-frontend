...
const Home = () => {
  ...
  <div className={`text-gray-100 min-h-screen ${colors.primary} relative overflow-x-hidden`}>
    ...
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      {/* Intensely Blurred Background Video */}
        <video
          autoPlay
          loop
          muted
          playsInline
          className="absolute top-0 left-0 w-full h-full object-cover z-0 brightness-[0.4] backdrop-blur-lg" // Extreme blur + zoom
        >
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 text-white drop-shadow-[0_5px_15px_rgba(0,0,0,0.2)]">
        ...
        <motion.p
          ...
          className="text-lg md:text-2xl mb-8 text-gray-100 max-w-2xl mx-auto drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]"
        >
          ...
          {[
            {
              ...
              description: "Our AI analyzes complex engineering texts and extracts key concepts, creating concise summaries that highlight the most important information. Perfect for exam prep and quick reviews.",
              icon: <FaBookOpen className="text-5xl text-cyan-400" />,
              image: "summarizer-image.jpg",
              reverse: false
            },
            {
              title: "Question Generator",
              description: "Automatically generates practice questions from your study materials. The AI creates multiple question types including conceptual, numerical, and application-based questions.",
              icon: <FaRobot className="text-5xl text-purple-400" />,
              image: "question-generator-image.jpg",
              reverse: true
            },
            {
              title: "AI Tutor Chat",
              description: "24/7 personalized assistance for all your engineering queries. Our chatbot understands technical concepts across multiple engineering disciplines and provides detailed explanations.",
              icon: <FaComments className="text-5xl text-green-400" />,
              image: "tutor-chat-image.jpg",
              reverse: false
            },
            {
              title: "Career Match",
              description: "Our system analyzes your skills and learning patterns to recommend the most suitable engineering career paths and job opportunities in your field.",
              icon: <FaBriefcase className="text-5xl text-yellow-400" />,
              image: "career-match-image.jpg",
              reverse: true
            }
          ].map((feature, index) => (
            <div 
            ...
            >
              ...
              <div className="md:w-1/2">
                ...
                >
                  <div className="w-full h-64 md:h-80 bg-gray-800/30 flex items-center justify-center">
                    <div className="text-4xl text-gray-500">Feature Image</div>
                  </div>
                </motion.div>
              </div>
            </div>
